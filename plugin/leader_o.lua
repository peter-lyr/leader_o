...
require 'which-key'.register {
  ...
  ['<leader>osa'] = { function() F.jump_or_split(Note .. '\\work_summary_day.org') end, 'open: work_summary_day.org', mode = { 'n', 'v', }, silent = true, },
  ['<leader>ose'] = { function() F.jump_or_split(Note .. '\\work_summary_week.org') end, 'open: work_summary_week.org', mode = { 'n', 'v', }, silent = true, },
