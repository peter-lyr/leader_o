...
require 'which-key'.register {
  ...
  ['<leader>ow'] = { function() F.jump_or_split(W .. '\\work.org') end, 'open: work.org', mode = { 'n', 'v', }, silent = true, },
  -- ['<leader>ow'] = { function() F.jump_or_split(Note .. '\\work.md') end, 'open: work.md', mode = { 'n', 'v', }, silent = true, },
  ['<leader>oa'] = { function() F.jump_or_split(W .. '\\work_summary_day.org') end, 'open: work_summary_day.org', mode = { 'n', 'v', }, silent = true, },
  ['<leader>oe'] = { function() F.jump_or_split(W .. '\\work_summary_week.org') end, 'open: work_summary_week.org', mode = { 'n', 'v', }, silent = true, },
