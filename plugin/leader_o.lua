...
require 'which-key'.register {
  ...
  ['<leader>oa'] = { function() F.jump_or_split(Note .. '\\work_summary_day.org') end, 'open: work_summary_day.org', mode = { 'n', 'v', }, silent = true, },
  ['<leader>oe'] = { function() F.jump_or_split(Note .. '\\work_summary_week.org') end, 'open: work_summary_week.org', mode = { 'n', 'v', }, silent = true, },
